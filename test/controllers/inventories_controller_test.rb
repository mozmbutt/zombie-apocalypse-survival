...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference('Inventory.count') do
      post inventories_url, params: { inventory: { user: @inventory.user, item: @inventory.item, stock: @inventory.stock } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { user: @inventory.user, item: @inventory.item, stock: @inventory.stock} }
